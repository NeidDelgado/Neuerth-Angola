...
<div class="container"><br><br><br><br>
    <span class="title sixteen columns"><h1>&nbsp;&nbsp; &nbsp;<?php echo __('Localização'); ?></h1></span>
    <div class="row section_featured_texts section_featured_texts_no_m">
        ...
        <div class="columns one-third"><br>
            ...
            <h4><?php echo __('• A'); ?> <strong><?php echo __('Neuerth Angola está localizada em Luanda no:'); ?></strong></h4><br>
                   <h5 class="icon_loc"><?php echo __('Kilamba Kiaxi, no Sapu II,'); ?> <br><?php echo __('Área total da Fábrica 15.000 m2.'); ?> </h5>
                   <h7><em>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; *<?php echo $this->Html->link(__('Para mais informacoes, envie um email para : geral@neuerthangola.co.ao'), '/quemsomos', array('escape'=> false)); ?></em></h7><br><br>
        </div>
    </div>
</div>	