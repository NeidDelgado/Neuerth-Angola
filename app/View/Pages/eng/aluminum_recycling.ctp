...
<div class="container"><br><br><br><br>
    <span class="title sixteen columns"><h1>&nbsp;&nbsp; &nbsp;<?php echo __('Line of Aluminum Recycling'); ?></h1></span><br>
    <div class="row section_featured_texts section_featured_texts_no_m">
        <div class="row">
            ...
            <div class="colun one-third">
                ...
                <h3><?php echo __('Aluminum Recycling'); ?></h3><br>
                <h5><?php echo __('• Reception and segregation of aluminum per technical specification'); ?></h5>
                <h5><?php echo __('• Compression of aluminum in standard formats'); ?></h5>
                <h5><?php echo __('• Two smelting furnaces'); ?></h5>
                <h5><?php echo __('• The furnaces are fueled with oil and thus reused'); ?></h5>
                <h5><?php echo __('• At the end of the aluminum bars are available for reuse'); ?></h5><br><br>
            </div>
        </div>
    </div>			
        <div class="row">
