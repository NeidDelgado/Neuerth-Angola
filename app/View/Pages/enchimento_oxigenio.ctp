        ...
        <div class="row"><br><br>
            <div class="nine columns flexslider"><br>	
                <ul class="slides services_list">
                  ...
                  <li><?php echo $this->Html->image('imagem33.png'); ?></li>
                  <li><?php echo $this->Html->image('imagem30.png'); ?></li>
            ...
            <div class="colun one-third">
                ...
                <h3><?php echo __('Enchimento de Oxigénio'); ?></h3><br>
                <h5><?php echo __('• O ar é comprimido pela utilização de compressor de alta pressão'); ?></h5>
                <h5><?php echo __('• Oxigénio produzido com recurso a unidades PSA e embalado em cilindros'); ?>&nbsp;</h5><br>
                <br><br><br><br>
            </div>
        </div>
    </div>			
