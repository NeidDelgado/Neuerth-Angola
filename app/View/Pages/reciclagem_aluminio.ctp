...
<div class="container"><br><br><br><br>
    <span class="title sixteen columns"><h1>&nbsp;&nbsp; &nbsp;<?php echo __('Linha de Reciclagem de Alumínio'); ?></h1></span><br>
        ...
        <div class="row">
            <div class="nine columns flexslider"><br>	
                <ul class="slides services_list">
                  <li><?php echo $this->Html->image('imagem39.png'); ?></li>
                  <li><?php echo $this->Html->image('imagem34.png'); ?></li>
                  <li><?php echo $this->Html->image('imagem40.png'); ?></li>
                  <li><?php echo $this->Html->image('imagem10.png'); ?></li>
                  <li><?php echo $this->Html->image('imagem12.png'); ?></li>
                  <li><?php echo $this->Html->image('imagem11.png'); ?></li>
                  <li><?php echo $this->Html->image('imagem13.png'); ?></li>
                  <li><?php echo $this->Html->image('imagem9.png'); ?></li>
                </ul>	
            </div> 	
            <div class="colun one-third">
                <span class="icon big_scre"></span>
                <h3><?php echo __('Reciclagem de Alumínio'); ?></h3><br>
                <h5><?php echo __('• Recepção e segregação do alumínio por especificação técnica'); ?></h5>
                <h5><?php echo __('• Compressao do alumínio em formatos normalizados'); ?></h5>
                <h5><?php echo __('• Dois fornos de fundição'); ?></h5>
                <h5><?php echo __('• Os fornos são alimentados a óleo usado e assim reutilizado'); ?></h5>
                <h5><?php echo __('• No final as barras de alumínio estão disponíveis para reutilização'); ?></h5><br><br>
            </div>
        </div>
    </div>			
    <div class="row">
